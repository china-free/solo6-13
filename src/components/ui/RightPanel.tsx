...
function CongestionList() {
  const { congestionZones } = useAppStore();
  return (
    <div>
      <div className="section-title flex items-center gap-1.5">
        ...
        {congestionZones.length === 0 ? (
          ...
          congestionZones.map((z, i) => {
            ...
            return (
              <div
                key={z.zoneId}
                className="rounded-lg border border-white/10 bg-space-850/50 p-2.5 hover:border-white/20 transition-all group"
              >
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <div className="flex-1">
                    <div className="text-xs font-semibold text-slate-100">{z.zoneName}</div>
